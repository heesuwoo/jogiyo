...
const join = async function (
  ...
  try {
    ...
    const query = `INSERT INTO USER_WEB (restaurant_id, 
      user_id, user_password, user_name, user_email, restaurant_name)VALUES ('${r_id}','${userID}', '${userPassword}', '${userName}', '${userEmail}', '${r_name}')`;
    console.log(query);
